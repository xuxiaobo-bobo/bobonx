...
console.log(document.createElement("script").type)
navigator = {
...
([function (e, t, o) {
    ...
    , function (e, t, n) {
        t = function (e, t, i) {
            var p = n(1)
                ...
                , v = function v(e, t) {
                var i, n, o, s = t.data, a = t.timeout || 1e4, r = t.onsuccess, c = t.onfailure,
    ...
    , function (t, i, p) {
        (function (u) {
                var e = function (e, t, i) {
                    var n, a = p(3), o = p(14), r = p(4), c = p(1), s = "手机号格式错误，请重新输入", d = "邮箱格式错误，请重新输入",
                        l = "系统异常，请重试";
                    (n = function n(e) {
                            this.name = e.name,
                            ...
                            "_importData": function (e, t) {
                                if (this.formElem) {
                                    ...
                                    for (var i = 0; i < t.length; i++) {
                                        var n, o = this._translateStr(String(t[i].name)), s = String(t[i].value),
                                            s = 0 <= this.noTranslateKeys.indexOf(o) ? this._translateStr(s, !0) : this._translateStr(s),
                                            a = String(t[i].type || "text");
        ...
        t = function (e, t, i) {
            var v = o(1)
                ...
                "request": function (e, t) {
                    var o, i, s, n = (t = t || {}).data || "", a = !1 !== t.async, r = t.username || "",
                        c = t.password || "", d = (t.method || "GET").toUpperCase(), l = t.headers || {},
                        u = t.timeout || 2e3, p = {}, h = t.withCredentials || !1;
...
function my() {
    ...
    function rsaFun(e) {
        var t = rsaUtils.getKeyPair("10001", "", "ab86b6371b5318aaa1d3c9e612a9f1264f372323c8c0f19875b5fc3b3fd3afcc1e5bec527aa94bfa85bffc157e4245aebda05389a5357b75115ac94f074aefcd");
        return rsaUtils.encryptedString(t, encodeURIComponent(e)).replace(/\s/g, "-")
    }

    password = 12345
    o = rsaFun(password)//password
    console.log(o)
    ...
    s = {
        ...
        "checkExist": 1,
        "device_id": "",
        "dfp": "a0cc8d88c28bf248149832174f744f1f0c4ceb975b633d33182c77cc2fbd6c4cfc",
        "email": "18036011152",
        "fromSDK": "1",
        "lang": "",
        "nr": 3,
    ...
    qd_sc = MD5.hex_md5(decodeURIComponent(jsonToQuery(s)) + "tS7BdPLU2w0JD89dh")  //qd_sc
    console.log(qd_sc)
}
